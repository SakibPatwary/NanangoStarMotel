        ...
        <Container className="my-4">
            ...
            <Row>
                ...
                <Col xs={12} sm={12} md={6} lg={4} className='pb-3'>
                    ...
                    >
                        <Card className="py-4 px-2 text-center" style={{ minHeight: '180px', backgroundColor: '#d1cfcf' }}>
                            <Card.Title style={{ fontWeight: 'bold' }}>24 Hours Manager Support
                            </Card.Title>
                            <Card.Text style={{ textAlign: 'justify' }}>
                                The motel has manager support 24/7 to assist guest with all the enquiries and services. Reception desk is open from 9AM till 7PM and after hours assistance by calling the motel number.
                            </Card.Text>
                        </Card></motion.div>
                </Col>
                <Col xs={12} sm={12} md={6} lg={4} className='pb-3'>
